...
| UC-ASM-12 | Người học | Làm và nộp bài tài liệu có sơ đồ Draw.io | Diagram Assignment | Cho phép người học vẽ UML trên canvas Draw.io, lưu nháp và nộp XML Draw.io đầy đủ làm bản chuẩn. (`US-ASM-003`, `US-ASM-004`) |
