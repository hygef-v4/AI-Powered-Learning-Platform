...
Danh mục hiện hành chỉ gồm **78 UC và 50 story thuộc MVP**. Thông báo/hỏi đáp lớp, dashboard cá nhân và xuất bảng điểm đều thuộc MVP. Mọi UC/story ngoài phạm vi đã được xóa khỏi hai catalog.
...
| U07 Payment & AI Credit | UC-PAY-01..02 | US-PAY-001..003 | 3 |
...
| **Tổng đang triển khai** | **78 UC** | **50 story** | **50** |
...
- U01-U16 bao phủ đúng 78 UC trong phạm vi, mỗi UC một primary unit; U03 có 0 UC vì là hạ tầng.
- Mọi story trong `stories.md` xuất hiện một lần ở bảng unit; catalog chỉ chứa 50 story MVP.
