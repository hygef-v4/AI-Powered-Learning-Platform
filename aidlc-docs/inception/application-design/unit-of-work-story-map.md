...
Catalog gốc: 90 UC, 59 story (48 MVP, 11 Phase 2). Điều chỉnh thiết kế đã bỏ 3 UC tiến độ bài học và 2 story tương ứng. Sau đó đã loại thêm UC-ASM-08/US-ASM-002 (đề chung cấp môn); US-CAT-005 (mã mời) và US-ASM-008 được đưa vào MVP. Phạm vi hiện tại: **86 UC, 56 story (47 MVP, 9 Phase 2)**.
...
| U02 Audit, Job & Event | UC-OPS-02 | US-AUD-001 | 1 | 0 | 1 |
| U03 File & Artifact | Không có UC trực tiếp | Hạ tầng dùng chung | 0 | 0 | 0 |
| U04 Subject, Class, Enrollment & Learning Access | UC-CAT-01..13, UC-LRN-01, 02, UC-CNT-04 | US-CAT-001..003, US-CAT-005, US-LRN-001 | 5 | 0 | 5 |
...
| U07 Payment & AI Credit | UC-PAY-01..02 | US-PAY-001..003 | 3 | 0 | 3 |
| U08 Assessment Core & Publication | UC-ASM-01, 07 | US-ASM-001 | 1 | 0 | 1 |
| U09 Question Type Authoring | UC-ASM-02, 03, 04, 06 (UC-ASM-08 đã loại) | US-ASM-004, 006, 007 (US-ASM-002 đã loại) | 3 | 0 | 3 |
| U10 Template, Copy & Simulation | UC-ASM-15..18 | US-ASM-008..011 | 4 | 0 | 4 |
| U11 Attempt & Submission | UC-ASM-09..14 | US-ASM-003 | 1 | 0 | 1 |
| U12 Group & Allocation | UC-GRP-01..04 | US-GRP-001..002 | 2 | 0 | 2 |
| U13 AI & Code Execution | UC-AIG-01..03, UC-ASM-05 | US-AIG-001..003, US-ASM-005 | 4 | 0 | 4 |
| U14 Group Document & Submission | UC-GRP-05..07 | US-GRP-003..005 | 3 | 0 | 3 |
| U15 Grading | UC-GRD-01..12, UC-GRP-08 | US-GRD-001..008, US-GRP-006 | 6 | 3 | 9 |
| U16 Reporting & Notification | UC-RPT-01..04, UC-OPS-01 | US-RPT-001..004, US-NTF-001 | 2 | 3 | 5 |
| **Tổng đang triển khai** | **86 UC** | **56 story** | **47** | **9** | **56** |
...
- U01-U16 bao phủ đúng 86 UC còn hiệu lực, mỗi UC một primary unit; U03 có 0 UC vì là hạ tầng.
