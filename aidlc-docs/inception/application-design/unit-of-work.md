...
| U12 | Group & Allocation | Bộ nhóm riêng cho từng bài nhóm (tạo tay, chia ngẫu nhiên, dùng lại nhóm của bài khác), đúng một leader, yêu cầu đổi leader, giảng viên phân phần việc | Không sở hữu phần nộp hay composite |
