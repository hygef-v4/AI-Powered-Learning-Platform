...
| Group Workspace UI | Nhóm, phần cá nhân, yêu cầu đổi leader, leader upload DOCX | Group API, Submission API |
| Teaching Console | Quản lý lớp, nội dung, bài, rubric, nhóm, chấm và báo cáo | Academic, Content, Assessment, Grading APIs |
| Subject Console | Học liệu/RAG, ngân hàng và đề chung theo môn | Subject-scoped APIs |
...
| Content | Nội dung và học liệu | Nội dung lớp, upload metadata, version, RAG source lifecycle |
...
| Assessment | Vòng đời bài đánh giá | Draft, review, publish, schedule, attempt, loại bài và common exam |
| Submission | Nháp và bản nộp | Autosave, immutable attempts, Draw.io full XML, DOCX chung, receipt |
| Grading | Chấm và công bố | Deterministic grading, manual/AI choice, final decision, gradebook, review |
