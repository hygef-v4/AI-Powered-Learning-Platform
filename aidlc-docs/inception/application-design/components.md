...
| Class Console | Môn, lớp, ghi danh, mã mời, nội dung lớp và bài học cấp môn | U04, U05 |
| Learner Space | Lớp của tôi, bài học, làm bài, lịch sử nộp, điểm, ví credit | U04, U05, U11, U15, U07 |
...
| Grading Console | Hàng chờ chấm, chấm tay/AI đề xuất theo rubric checklist, chốt, công bố, sổ điểm, tiến độ nộp | U15, U16 |
...
| Content & RAG (U05) | Chương → bài → mục, phiên bản bài, bài cấp môn liên kết vào lớp, YouTube (chỉ caption có sẵn), trích chữ, embedding Gemini + pgvector, `retrieve` |
...
| Reporting & Notification (U16) | Thông báo trong app (SSE), email có trần, nhắc hạn, tiến độ nộp |
...
- AI chỉ trả đề xuất; không phát hành đề, không chốt điểm; mọi lời gọi AI trừ credit của người yêu cầu.
