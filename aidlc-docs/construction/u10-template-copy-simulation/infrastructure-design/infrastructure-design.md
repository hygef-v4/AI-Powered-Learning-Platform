...
- `simulation_policies (publication_id PK FK publications, max_attempts NULL CHECK (max_attempts IS NULL OR max_attempts >= 1), result_policy, answer_release, counts_toward_grade, locked_at)`.
