...
- [ ] **Bước 9** - `AiAdminService`: cấu hình theo việc, trần, kill-switch (cài `AiKillSwitchPort` thay biến `.env` của U05), báo cáo (F5, BR-U13-40, 41).
...
- [ ] **Bước 20** - `/contracts/openapi/u13-ai-code.yaml` và schema event.
